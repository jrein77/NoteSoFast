...
The application, by default, runs in mock mode so it doesnt incur API cost. To change it, add an API key and click the "Mock Mode" button in the sidebar of the chat to switch to "Live API". Then, the responses will mirror the example provided in the video walkthrough. 
